...
public class CommonSetup {
	...
	public static void init(final FMLCommonSetupEvent event) {
		...
		CHANNEL.registerMessage(CUSTOMPARTICLE_MESSAGE_ID, CustomParticleMessage.class, CustomParticleMessage::encode, CustomParticleMessage::decode, ParticleClientMessageHandler::onMessageReceived, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
