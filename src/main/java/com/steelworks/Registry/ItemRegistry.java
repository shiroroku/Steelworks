...
public class ItemRegistry {
	...
	public static RegistryObject<Item> STEEL_SHOVEL = ITEMS.register("steel_shovel", () -> new ShovelItem(new SteelItemTier(), 1F, -3.0F, new Item.Properties().tab(Steelworks.CREATIVETAB)));
